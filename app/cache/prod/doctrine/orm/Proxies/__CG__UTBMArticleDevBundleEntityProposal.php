 ...
 */
class Proposal extends \UTBM\ArticleDevBundle\Entity\Proposal implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setPEntitled($pEntitled);
    }

    public function getPEntitled()
    {
        $this->__load();
        return parent::getPEntitled();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'pEntitled', 'answer', 'question');
    }
