...
";
    ...
    <div class=\"well\">
        ...
        // line 34
        if (isset($context["lMenuElt"])) { $_lMenuElt_ = $context["lMenuElt"]; } else { $_lMenuElt_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("article_dev_delLMenuElt", array("id" => $this->getAttribute($_lMenuElt_, "id"))), "html", null, true);
        echo "\" method='post' ";
