...
";
    ...
    <div class=\"well\">
        ...
        // line 34
        if (isset($context["lMenu"])) { $_lMenu_ = $context["lMenu"]; } else { $_lMenu_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("article_dev_delLMenu", array("id" => $this->getAttribute($_lMenu_, "id"))), "html", null, true);
        echo "\" method='post' ";
